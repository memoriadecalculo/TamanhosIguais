        ...
        if os.path.isfile(DirArq) and ExtArq in ListExtDes:
            if ListArqDupTmp.has_key(Arq):
                if ListArqsDups.has_key(Arq):
                    ...
                    ListArqsDups[Arq] = (ListArqDupTmp[Arq], (DirArq, TamArq))
                    ListArqDupTam[Arq] = False
                for ind in range(0, len(ListArqsDups[Arq])-1, 1):
                    if TamArq == ListArqsDups[Arq][ind][1]:
                        ListArqDupTam[Arq] = True
            else:
